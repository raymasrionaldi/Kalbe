...
class LeaveRequestExpandableListAdapter(
    ...
    override fun getGroupView(
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.list_approval_leave_request, null)
        }

        val listGroupName = convertView!!.findViewById(R.id.namaGrupLeave) as TextView
        listGroupName.text = groupName

        val arrowDown = convertView.findViewById(R.id.arrowDownLeave) as ImageView
        val arrowUp = convertView.findViewById(R.id.arrowUpLeave) as ImageView
    ...
    override fun getChildView(
        ...
        if (convertView == null) {
            val inflater = this.mContext
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater
            convertView = inflater.inflate(R.layout.list_sub_approval_leave_request, null)
        }

        val txtListChildName = convertView!!
            .findViewById(R.id.subApprovalName) as TextView
        val txtListChildValue = convertView!!
            .findViewById(R.id.subApprovalValue) as TextView
